...
func TestPresetsAreNotContradictingEachOther(t *testing.T) {
	t.Run("errors", func(t *testing.T) {
		t.Run("contradicting entries", func(t *testing.T) {
			ct := getCTfromYamlFile(t, "resolveContradicting.yml")
			err := ct.presetsAreNotContradicting("p1", "p2")
			expectError(t, err)
		})
		...
		t.Run("non-existent presets", func(t *testing.T) {
			...
			err = ct.presetsAreNotContradicting("p2")
			expectError(t, err)
		})
	})
	...
	t.Run("valid", func(t *testing.T) {
		...
		t.Run("empty list", func(t *testing.T) {
			...
			err := ct.presetsAreNotContradicting(p1.Presets()...)
			expectNoError(t, err)
		})
		...
		t.Run("list with one element", func(t *testing.T) {
			...
			err := ct.presetsAreNotContradicting(p2.Presets()...)
			expectNoError(t, err)
		})
		...
		t.Run("list with more elements", func(t *testing.T) {
			...
			err := ct.presetsAreNotContradicting(p4.Presets()...)
			expectNoError(t, err)
		})
		...
		t.Run("list with duplicate elements", func(t *testing.T) {
			...
			err := ct.presetsAreNotContradicting(p5.Presets()...)
			expectNoError(t, err)
		})
	})
}
